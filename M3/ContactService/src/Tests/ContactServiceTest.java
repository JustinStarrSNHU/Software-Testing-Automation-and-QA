...
class ContactServiceTest {
	...
	void testAddContactWithSameIdDoesNotAddContact() {
		service.addContact("0123456789", "Justin", "Starr", "0123456789", "My Home Address"); // adds a new contact
		try {
			service.addContact("0123456789", "Justin", "Starr", "0123456789", "My Home Address");  // tries to add a new contact with a contactId that has already been used
